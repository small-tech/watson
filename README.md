...
A project generated by Watson complies with the [elementary OS Human Interface Guidelines](https://docs.elementary.io/hig/) and [coding style](https://docs.elementary.io/develop/writing-apps/code-style).

If you haven’t already done so, we highly recommended you read through both of those important resources before continuing. Also, to refer to language or library details during development, bookmark [Valadoc](https://valadoc.org/).
